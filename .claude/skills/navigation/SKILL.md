...
Do not navigate to /tunes/new - If user needs to upload a new reference, stay in /prompts (Generate tab) and ask the user to drag a new reference product into the prompt box, or click the Plus icon to upload.
